...
export class GridContentCreator extends BaseScriptComponent {
  ...
  private data = [];
  private scenceObj: SceneObject = null;
  //   @input
  ...
  populateGrid() {
    const itemsCount: number = this.data.length;
    if (!this.itemPrefab) {
      throw new Error(
    ...
    for (let i = 0; i < itemsCount; i++) {
      ...
      item
        ...
        .onButtonPinched.add(() => {
          ...
          const resource =
            this.remoteServiceModule.makeResourceFromUrl(imageUrl);
          ...
          this.remoteMediaModule.loadResourceAsVideoTexture(
            ...
            (texture) => {
              ...
              provider.onPlaybackDone.add(() => {
                ...
                if (this.scenceObj) this.scenceObj.destroy();
              });
            },
            (error) => {
  ...
  setData() {
    this.data = [
...

      {
        ...
        imageMedia:
          "https://xqcxapescjjgidskqnhw.supabase.co/storage/v1/object/public/pics/IMG_2753.mov",
      },
      {
        name: "Hackathon with Hoang",
        description: "19th Sep 2024",
        imageMedia:
          "https://xqcxapescjjgidskqnhw.supabase.co/storage/v1/object/public/pics/IMG_3043.mov?t=2024-10-13T14%3A58%3A02.753Z",
      },
      {
      ...
      },
      {
        ...
        description: "4th October 2024",
        imageMedia:
          "https://xqcxapescjjgidskqnhw.supabase.co/storage/v1/object/public/pics/IMG_3042.mov?t=2024-10-13T14%3A58%3A17.848Z",
      },
      {
        name: "Sleeping with Hoang",
